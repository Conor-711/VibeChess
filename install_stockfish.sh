...
cp stockfish/stockfish-ubuntu-x86-64-avx2 /opt/render/project/bin/stockfish

# 设置环境变量
echo "配置环境变量..."
echo "export STOCKFISH_PATH=/opt/render/project/bin/stockfish" >> ~/.bashrc
export STOCKFISH_PATH=/opt/render/project/bin/stockfish
